...
main_application.title("Pawan Text Editor 'first project python 97736020..'")
...
color_icons = (dark_icon, red_icon, monokai_icon, night_blue_icon)
color_dict ={'Dark' : ('#c4c4c4', '#2d2d2d'),
    'Red' : ('#2d2d2d', '#ffe8e8'),
